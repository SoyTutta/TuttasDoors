...
public class TDItemTags extends ItemTagsProvider
{
    ...
    private void registerModTags() {
        ...
        tag(TDTags.WOODEN_INDISCRETE_DOORS_ITEMS).add(TDItems.OAK_DISCRETE_DOOR.get(), TDItems.SPRUCE_INDISCRETE_DOOR.get(), TDItems.BIRCH_INDISCRETE_DOOR.get(),TDItems.JUNGLE_DISCRETE_DOOR.get(), Items.ACACIA_DOOR, TDItems.DARK_OAK_INDISCRETE_DOOR.get(), TDItems.MANGROVE_INDISCRETE_DOOR.get(), TDItems.CHERRY_INDISCRETE_DOOR.get(), TDItems.BAMBOO_INDISCRETE_DOOR.get(), TDItems.CRIMSON_INDISCRETE_DOOR.get(), TDItems.WARPED_INDISCRETE_DOOR.get());
        ...
        /// tag(TDTags.WOODEN_TRANSIT_GATES_ITEMS).add(TDItems.OAK_TRANSIT_GATE.get(), TDItems.SPRUCE_TRANSIT_GATE.get(), TDItems.BIRCH_TRANSIT_GATE.get(),TDItems.JUNGLE_TRANSIT_GATE.get(), TDItems.ACACIA_TRANSIT_GATE.get(), TDItems.DARK_OAK_TRANSIT_GATE.get(), TDItems.MANGROVE_TRANSIT_GATE.get(), TDItems.CHERRY_TRANSIT_GATE.get(), TDItems.BAMBOO_TRANSIT_GATE.get(), TDItems.CRIMSON_TRANSIT_GATE.get(), TDItems.WARPED_TRANSIT_GATE.get());
